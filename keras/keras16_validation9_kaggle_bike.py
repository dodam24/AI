...
start = time.time()
model.fit(x_train, y_train, epochs=8000, batch_size=32)
end = time.time()
...
sampleSubmission.to_csv(path + 'sampleSubmission_01060540.csv')   # to_csv에 경로와 파일명 입력

# # 결과
# RMSE :  182.12229665198066
# loss :  33168.5234375