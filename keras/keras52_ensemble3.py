...
#2-5. 모델 병합한 것 다시 둘로 쪼개기 (1) -모델 5 = 분기 1
...
#2-6. 모델 병합한 것 다시 둘로 쪼개기 (2) -모델 6 = 분기 2
...
model.fit([x1_train, x2_train, x3_train], [y1_train, y2_train] epochs=500, batch_size=5)
